...
export default function ReactCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'React_Beginner',
      description: 'Learn the basics of React.js, including components, JSX, state, and props to build your first web applications.',
      progress: 30,
      isSaved: false,
      imageUrl: '/reB.png',
  
      resources: [
        { type: 'pdf', title: 'React Basics', url: '/pdfs/react-basics.pdf' },
        { type: 'link', title: 'React Official Docs', url: 'https://reactjs.org/docs/getting-started.html' },
      ],
    },
    {
      id: 2,
      title: 'React_Intermediate',
      description: 'Build more complex React applications with hooks, context, and routing to manage state and handle side effects.',
      progress: 50,
      isSaved: false,
      imageUrl: '/reI.webp',
  
      resources: [
        { type: 'pdf', title: 'Intermediate React Concepts', url: '/pdfs/react-intermediate.pdf' },
        { type: 'link', title: 'React Hooks Tutorial', url: 'https://reactjs.org/docs/hooks-intro.html' },
      ],
    },
    {
      id: 3,
      title: 'React_Advanced',
      description: 'Master advanced React concepts such as optimization, testing, and integration with state management tools like Redux.',
      progress: 0,
      isSaved: true,
      imageUrl: '/reA.avif',
  
      resources: [
        { type: 'pdf', title: 'Advanced React Techniques', url: '/pdfs/react-advanced.pdf' },
        { type: 'link', title: 'React Performance Optimization', url: 'https://reactjs.org/docs/optimizing-performance.html' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            Learn to build interactive user interfaces with React library.
...
Delete                    
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/reactdebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/reactintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/reactadvanced' });
                  }}
