...
const MOCK_COURSES = [
    {
      id: 1,
      title: "Angular Advanced Component Design",
      description: "Master the art of designing reusable, maintainable, and efficient components in Angular.",
    ...
    },
    {
      ...
      description: "Learn advanced techniques to optimize the performance of your Angular applications.",
    ...
    {
      id: 3,
      title: "Angular Programming with RxJS",
      description: " learn how to manage complex state and operations in Angular.",
...
export default function Angularadvanced() {
