...
export default function VueCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'VueJS_Beginner',
      description: 'Learn the basics of Vue.js to build interactive web applications, covering Vue components, directives, and reactivity.',
      progress: 30,
      isSaved: false,
      imageUrl: '/vuB.avif',
  
      resources: [
        { type: 'pdf', title: 'Vue.js Guide', url: '/pdfs/vuejs-guide.pdf' },
        { type: 'link', title: 'Vue.js Official Documentation', url: 'https://vuejs.org' },
      ],
    },
    {
      id: 2,
      title: 'VueJS_Intermediate',
      description: 'Deepen your knowledge of Vue.js with topics such as Vue Router, Vuex for state management, and how to build dynamic web applications.',
      progress: 50,
      isSaved: false,
      imageUrl: '/vuI.webp',
  
      resources: [
        { type: 'pdf', title: 'Vue.js Intermediate Concepts', url: '/pdfs/vuejs-intermediate.pdf' },
        { type: 'link', title: 'Vuex for State Management', url: 'https://vuex.vuejs.org' },
      ],
    },
    {
      id: 3,
      title: 'VueJS_Advanced',
      description: 'Master advanced Vue.js topics such as server-side rendering (SSR), component patterns, Vue 3 Composition API, and optimization techniques.',
      progress: 0,
      isSaved: true,
      imageUrl: '/vuA.png',
  
      resources: [
        { type: 'pdf', title: 'Vue 3 Advanced Topics', url: '/pdfs/vue3-advanced.pdf' },
        { type: 'link', title: 'Vue 3 Composition API', url: 'https://vuejs.org/guide/extras/composition-api.html' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Vue.js</h1>
          </div>
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/vuedebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/vueintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/vueadvanced' });
                  }}
