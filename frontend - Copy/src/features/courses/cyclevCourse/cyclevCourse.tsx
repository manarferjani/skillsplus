...
export default function VcycleCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'V_Cycle_Beginner',
      description: 'Learn the basics of the V-Cycle methodology to manage your projects from start to finish.',
      progress: 30,
      isSaved: false,
      imageUrl: '/cycB.webp',
      resources: [
        { type: 'pdf', title: 'V-Cycle Basics', url: '/pdfs/v-cycle-basics.pdf' },
        { type: 'link', title: 'V-Cycle Methodology Overview', url: 'https://example.com/v-cycle' },
      ],
    },
    {
      id: 2,
      title: 'V_Cycle_Intermediate',
      description: 'A comprehensive course on V-Cycle to apply its principles in real-world projects.',
      progress: 50,
      isSaved: false,
      imageUrl: '/cycI.png',
  
      resources: [
        { type: 'pdf', title: 'V-Cycle Intermediate Concepts', url: '/pdfs/v-cycle-intermediate.pdf' },
        { type: 'link', title: 'V-Cycle in Practice', url: 'https://example.com/v-cycle-practice' },
      ],
    },
    {
      id: 3,
      title: 'V_Cycle_Advanced',
      description: 'Master the advanced techniques and best practices for implementing the V-Cycle in complex projects.',
      progress: 0,
      isSaved: true,
      imageUrl: '/cycA.webp',
  
      resources: [
        { type: 'pdf', title: 'Advanced V-Cycle Tips', url: '/pdfs/v-cycle-advanced-tips.pdf' },
        { type: 'link', title: 'Best Practices for V-Cycle', url: 'https://dev.to/v-cycle' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">V Cycle</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            linear project management method where each design step is followed by a corresponding validation phase
                        </p>
            <button
  ...
  />
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/cyclevdebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/cyclevintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/cyclevadvanced' });
                  }}
          ...
          <div className="bg-white rounded-3xl p-6 w-full max-w-md shadow-lg relative">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-black text-white py-2 rounded-xl hover:bg-gray-400"
              >
                Add Course
              </button>
            </div>
