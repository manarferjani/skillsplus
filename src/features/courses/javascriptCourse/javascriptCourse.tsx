...
export default function JavascriptCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'JavaScript_Beginner',
      description: 'Learn the basics of JavaScript to start creating interactive webpages.',
      progress: 30,
      isSaved: false,
      imageUrl: '/jsB.png',
  
      resources: [
        { type: 'pdf', title: 'JavaScript Basics', url: '/pdfs/javascript-basics.pdf' },
        { type: 'link', title: 'JavaScript Docs', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
      ],
    },
    {
      id: 2,
      title: 'JavaScript_Intermediate',
      description: 'A comprehensive course on JavaScript to build dynamic and interactive applications.',
      progress: 50,
      isSaved: false,
      imageUrl: '/jsI.png',
  
      resources: [
        { type: 'pdf', title: 'JavaScript Intermediate', url: '/pdfs/javascript-intermediate.pdf' },
        { type: 'link', title: 'JavaScript ES6 Features', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let' },
        { type: 'link', title: 'JavaScript Array Methods', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array' },
      ],
    },
    {
      id: 3,
      title: 'JavaScript_Advanced',
      description: 'Master advanced JavaScript concepts for building complex applications and working with APIs.',
      progress: 0,
      isSaved: true,
      imageUrl: '/jsA.png',
  
      resources: [
        { type: 'pdf', title: 'Advanced JavaScript Techniques', url: '/pdfs/javascript-advanced.pdf' },
        { type: 'link', title: 'JavaScript Promises', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise' },
        { type: 'link', title: 'JavaScript Async/Await', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Javascript (JS)</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            Learn the core programming language of the web: JavaScript.
  ...
  />
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/javascriptdebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/javascriptintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/javascriptadvanced' });
                  }}
