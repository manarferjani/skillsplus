      ...
      <div className='w-[45%] h-full bg-[#1a1a1a] flex flex-col p-20 justify-center'>
        ...
        <div className='w-full flex flex-col max-w-[450px] ml-auto mr-0'>
          ...
          <div className='w-full max-w-[350px] flex flex-col mb-10 text-white'>
            <h3 className='text-3xl font-bold mb-2'>Log In</h3> {/* Titre aligné à droite */}
            <p className='text-sm mb-4'>Welcome back! Please enter your credentials to access your account.</p> {/* Texte Welcome! aligné à droite */}
          </div>
          ...
          <div className='w-full flex flex-col mb-6'>
            ...
            <div className='relative w-full max-w-[350px]'>
              ...
              >
                {showPassword ? <FaEyeSlash className='h-4 w-4' /> : <FaEye className='h-4 w-4' />} {/* Afficher l'icône appropriée */}
              </button>
            </div>
          </div>
          ...
          {/* Buttons to log in with Google, Facebook, or GitHub */}
