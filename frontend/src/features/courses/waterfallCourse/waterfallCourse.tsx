...
export default function WaterfallCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'Waterfall_Beginner',
      description: 'Learn the fundamentals of the Waterfall model, focusing on its sequential phases such as requirements gathering, design, implementation, and testing.',
      progress: 30,
      isSaved: false,
      imageUrl: '/watB.jpg',
  
      resources: [
        { type: 'pdf', title: 'Waterfall Basics', url: '/pdfs/waterfall-basics.pdf' },
        { type: 'link', title: 'Waterfall Model Overview', url: 'https://www.tutorialspoint.com/sdlc/sdlc_waterfall_model.htm' },
      ],
    },
    {
      id: 2,
      title: 'Waterfall_Intermediate',
      description: 'Explore more advanced topics in the Waterfall methodology, including handling changes during the project, risk management, and documentation.',
      progress: 50,
      isSaved: false,
      imageUrl: '/watI.png',
  
      resources: [
        { type: 'pdf', title: 'Waterfall Model Intermediate Concepts', url: '/pdfs/waterfall-intermediate.pdf' },
        { type: 'link', title: 'SDLC Waterfall Model Details', url: 'https://www.sdlc.com/waterfall-methodology' },
      ],
    },
    {
      id: 3,
      title: 'Waterfall_Advanced',
      description: 'Master the advanced techniques of the Waterfall model, including detailed project planning, budget estimation, and project tracking for large-scale projects.',
      progress: 0,
      isSaved: true,
      imageUrl: '/watA.png',
  
      resources: [
        { type: 'pdf', title: 'Waterfall Advanced Practices', url: '/pdfs/waterfall-advanced.pdf' },
        { type: 'link', title: 'Advanced Waterfall Practices', url: 'https://www.projectmanagement.com/waterfall-advanced' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Waterfall</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            Traditional sequential project management methodology.
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/waterdebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/waterintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/wateradvanced' });
                  }}
