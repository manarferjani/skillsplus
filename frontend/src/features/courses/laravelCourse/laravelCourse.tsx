...
export default function LaravelCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'Laravel_Beginner',
      description: 'Learn the basics of Laravel to build your first web applications with PHP.',
      progress: 30,
      isSaved: false,
      imageUrl: '/larB.avif',
  
      resources: [
        { type: 'pdf', title: 'Laravel Basics', url: '/pdfs/laravel-basics.pdf' },
        { type: 'link', title: 'Laravel Documentation', url: 'https://laravel.com/docs' },
      ],
    },
    {
      id: 2,
      title: 'Laravel_Intermediate',
      description: 'Explore more advanced Laravel features, including database migrations, routing, and Eloquent ORM.',
      progress: 50,
      isSaved: false,
      imageUrl: '/larI.webp',
  
      resources: [
        { type: 'pdf', title: 'Laravel Intermediate', url: '/pdfs/laravel-intermediate.pdf' },
        { type: 'link', title: 'Laravel Advanced Features', url: 'https://laravel.com/docs/8.x/eloquent' },
      ],
    },
    {
      id: 3,
      title: 'Laravel_Advanced',
      description: 'Master Laravel’s advanced features, including queues, services, and testing to build high-quality applications.',
      progress: 0,
      isSaved: true,
      imageUrl: '/larA.webp',
  
      resources: [
        { type: 'pdf', title: 'Advanced Laravel Techniques', url: '/pdfs/laravel-advanced.pdf' },
        { type: 'link', title: 'Laravel Best Practices', url: 'https://laravel-news.com' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Laravel</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            PHP framework for elegant web application development.
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/laraveldebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/laravelintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/laraveladvanced' });
                  }}
