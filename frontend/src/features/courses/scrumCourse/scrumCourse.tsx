...
export default function ScrumCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'Scrum_Beginner',
      description: 'Learn the fundamentals of Scrum, including Scrum roles, events, and artifacts, and how to apply Scrum to manage projects effectively.',
      progress: 30,
      isSaved: false,
      imageUrl: '/scB.jpg',
  
      resources: [
        { type: 'pdf', title: 'Scrum Guide', url: '/pdfs/scrum-guide.pdf' },
        { type: 'link', title: 'Scrum Official Website', url: 'https://www.scrum.org' },
      ],
    },
    {
      id: 2,
      title: 'Scrum_Intermediate',
      description: 'Explore intermediate Scrum concepts, including sprint planning, retrospectives, product backlog management, and team collaboration.',
      progress: 50,
      isSaved: false,
      imageUrl: '/scI.webp',
  
      resources: [
        { type: 'pdf', title: 'Advanced Scrum Practices', url: '/pdfs/advanced-scrum.pdf' },
        { type: 'link', title: 'Scrum Master Role', url: 'https://www.scrum.org/resources/scrum-master' },
      ],
    },
    {
      id: 3,
      title: 'Scrum_Advanced',
      description: 'Master advanced Scrum techniques and scaling Scrum to larger teams and organizations, focusing on Scrum of Scrums and other advanced topics.',
      progress: 0,
      isSaved: true,
      imageUrl: '/scA.jpg',
  
      resources: [
        { type: 'pdf', title: 'Scaling Scrum with LeSS', url: '/pdfs/less-scrum.pdf' },
        { type: 'link', title: 'Advanced Scrum Practices', url: 'https://www.scrum.org/resources/blog/advanced-scrum-practices' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Scrum</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            Agile framework for effective project management.
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/scrumdebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/scrumintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/scrumadvanced' });
                  }}
