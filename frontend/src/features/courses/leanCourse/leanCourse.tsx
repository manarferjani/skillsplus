...
export default function LeanCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'Lean_Beginner',
      description: 'Learn the fundamentals of Lean methodology, focusing on efficiency and waste reduction in processes.',
      progress: 30,
      isSaved: false,
      imageUrl: '/leanB.webp',
  
      resources: [
        { type: 'pdf', title: 'Lean Basics', url: '/pdfs/lean-basics.pdf' },
        { type: 'link', title: 'Introduction to Lean', url: 'https://www.lean.org/WhatsLean/' },
      ],
    },
    {
      id: 2,
      title: 'Lean_Intermediate',
      description: 'Dive deeper into Lean principles such as Kaizen, Value Stream Mapping, and Continuous Improvement.',
      progress: 50,
      isSaved: false,
      imageUrl: '/leanI.jpeg',
  
      resources: [
        { type: 'pdf', title: 'Intermediate Lean Concepts', url: '/pdfs/lean-intermediate.pdf' },
        { type: 'link', title: 'Lean Management', url: 'https://www.lean.org/WhoWeAre/NewsArticleDocuments/Lean%20Management%20Principles.pdf' },
      ],
    },
    {
      id: 3,
      title: 'Lean_Advanced',
      description: 'Master advanced Lean tools and techniques such as Lean Six Sigma, DMAIC, and advanced problem-solving strategies.',
      progress: 0,
      isSaved: true,
      imageUrl: '/LeanA.jpg',
  
      resources: [
        { type: 'pdf', title: 'Advanced Lean Tools', url: '/pdfs/lean-advanced.pdf' },
        { type: 'link', title: 'Lean Six Sigma', url: 'https://www.sixsigma.us/lean-six-sigma/' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Lean</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            Methodology for maximizing value while minimizing waste.
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/leandebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/leanintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/leanadvanced' });
                  }}
