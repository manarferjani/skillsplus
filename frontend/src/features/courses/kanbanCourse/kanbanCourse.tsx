...
export default function KanbanCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'Kanban_Beginner',
      description: 'Learn the basics of Kanban to improve workflow management and increase team efficiency.',
      progress: 30,
      isSaved: false,
      imageUrl: '/kanB.jpg',
  
      resources: [
        { type: 'pdf', title: 'Kanban Basics', url: '/pdfs/kanban-basics.pdf' },
        { type: 'link', title: 'Kanban Guide', url: 'https://kanbanize.com/kanban-resources/kanban-guide' },
      ],
    },
    {
      id: 2,
      title: 'Kanban_Intermediate',
      description: 'Dive deeper into Kanban to manage complex workflows and optimize team productivity.',
      progress: 50,
      isSaved: false,
      imageUrl: '/kanI.jpg',
  
      resources: [
        { type: 'pdf', title: 'Kanban Intermediate', url: '/pdfs/kanban-intermediate.pdf' },
        { type: 'link', title: 'Kanban System Design', url: 'https://www.smartsheet.com/kanban-system-design' },
      ],
    },
    {
      id: 3,
      title: 'Kanban_Advanced',
      description: 'Master advanced Kanban techniques to manage large-scale projects and maximize efficiency.',
      progress: 0,
      isSaved: true,
      imageUrl: '/kanA.png',
  
      resources: [
        { type: 'pdf', title: 'Advanced Kanban Techniques', url: '/pdfs/kanban-advanced.pdf' },
        { type: 'link', title: 'Kanban Best Practices', url: 'https://www.mightyteam.com/kanban-best-practices' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            Visual workflow management methodology.
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/kanbandebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/kanbanintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/kanbanadvanced' });
                  }}
