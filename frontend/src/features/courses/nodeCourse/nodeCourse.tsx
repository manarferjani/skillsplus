...
export default function NodeCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'NodeJS_Beginner',
      description: 'Learn the basics of Node.js to build scalable web applications using JavaScript on the server side.',
      progress: 30,
      isSaved: false,
      imageUrl: '/nodeB.jpg',
  
      resources: [
        { type: 'pdf', title: 'Node.js Basics', url: '/pdfs/nodejs-basics.pdf' },
        { type: 'link', title: 'Node.js Official Docs', url: 'https://nodejs.org/en/docs/' },
      ],
    },
    {
      id: 2,
      title: 'NodeJS_Intermediate',
      description: 'Expand your knowledge with more advanced Node.js concepts like Express.js, middleware, and APIs.',
      progress: 50,
      isSaved: false,
      imageUrl: '/nodI.webp',
  
      resources: [
        { type: 'pdf', title: 'Node.js Advanced Concepts', url: '/pdfs/nodejs-intermediate.pdf' },
        { type: 'link', title: 'Building REST APIs with Node.js', url: 'https://expressjs.com/en/starter/installing.html' },
      ],
    },
    {
      id: 3,
      title: 'NodeJS_Advanced',
      description: 'Master advanced Node.js topics such as performance optimization, asynchronous programming, and working with databases.',
      progress: 0,
      isSaved: true,
      imageUrl: '/nodA.png',
  
      resources: [
        { type: 'pdf', title: 'Advanced Node.js Tips', url: '/pdfs/nodejs-advanced.pdf' },
        { type: 'link', title: 'Node.js Performance', url: 'https://nodejs.org/en/docs/guides/diagnostics-tools/' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Node.js</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            Master JavaScript runtime for building server-side applications.
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/nodedebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/nodeintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/nodeadvanced' });
                  }}
