...
export default function KotlinCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'Kotlin_Beginner',
      description: 'Learn the basics of Kotlin to start developing Android apps and backend applications.',
      progress: 30,
      isSaved: false,
      imageUrl: '/kotB.webp',
  
      resources: [
        { type: 'pdf', title: 'Kotlin Basics', url: '/pdfs/kotlin-basics.pdf' },
        { type: 'link', title: 'Kotlin Documentation', url: 'https://kotlinlang.org/docs/home.html' },
      ],
    },
    {
      id: 2,
      title: 'Kotlin_Intermediate',
      description: 'Dive into more advanced Kotlin features to build robust applications and explore Kotlin in Android.',
      progress: 50,
      isSaved: false,
      imageUrl: '/kotI.jpg',
  
      resources: [
        { type: 'pdf', title: 'Kotlin Intermediate', url: '/pdfs/kotlin-intermediate.pdf' },
        { type: 'link', title: 'Kotlin Android Tutorial', url: 'https://developer.android.com/kotlin' },
      ],
    },
    {
      id: 3,
      title: 'Kotlin_Advanced',
      description: 'Master Kotlin’s advanced features to build high-performance and scalable applications.',
      progress: 0,
      isSaved: true,
      imageUrl: '/kotA.png',
  
      resources: [
        { type: 'pdf', title: 'Advanced Kotlin Techniques', url: '/pdfs/kotlin-advanced.pdf' },
        { type: 'link', title: 'Kotlin Best Practices', url: 'https://kotlinlang.org/docs/reference/coding-conventions.html' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">Kotlin</h1>
          </div>
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/kotlindebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/kotlinintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/kotlinadvanced' });
                  }}
