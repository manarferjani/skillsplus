...
export default function SafeCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'SAFe_Beginner',
      description: 'Introduction to the Scaled Agile Framework (SAFe) for building large-scale agile organizations, focusing on principles, roles, and processes.',
      progress: 30,
      isSaved: false,
      imageUrl: '/saB.png',
  
      resources: [
        { type: 'pdf', title: 'SAFe Principles Overview', url: '/pdfs/safe-principles.pdf' },
        { type: 'link', title: 'SAFe Official Website', url: 'https://www.scaledagileframework.com/' },
      ],
    },
    {
      id: 2,
      title: 'SAFe_Intermediate',
      description: 'Explore the core components of SAFe, including Agile Release Trains (ARTs), Program Increment (PI) planning, and how to implement SAFe in your organization.',
      progress: 50,
      isSaved: false,
      imageUrl: '/saI.webp',
  
      resources: [
        { type: 'pdf', title: 'SAFe Implementation Roadmap', url: '/pdfs/safe-implementation-roadmap.pdf' },
        { type: 'link', title: 'SAFe Lean-Agile Leadership', url: 'https://www.scaledagileframework.com/lean-agile-leadership/' },
      ],
    },
    {
      id: 3,
      title: 'SAFe_Advanced',
      description: 'Advanced SAFe topics including continuous delivery pipeline, DevOps, and scaling Lean-Agile practices across enterprise-level initiatives.',
      progress: 0,
      isSaved: true,
      imageUrl: '/saA.webp',
  
      resources: [
        { type: 'pdf', title: 'Advanced SAFe Practices', url: '/pdfs/advanced-safe.pdf' },
        { type: 'link', title: 'SAFe for Lean Enterprises', url: 'https://www.scaledagileframework.com/lean-enterprise/' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">SAFe</h1>
          </div>
  
          <div className="flex items-center justify-between mt-4">
            <p className="text-lg text-gray-700">
            Scaled Agile Framework for enterprise development.
...
Delete                    </button>
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/safedebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/safeintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/safeadvanced' });
                  }}
