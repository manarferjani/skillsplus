...
export default function HtmlcssCourse() {
  ...
  const [courses, setCourses] = useState<Course[]>([
    {
      id: 1,
      title: 'HTML_CSS_Beginner',
      description: 'Learn the basics of HTML and CSS to create your first webpages.',
      progress: 30,
      isSaved: false,
      imageUrl: '/htB.webp',
  
      resources: [
        { type: 'pdf', title: 'HTML and CSS Basics', url: '/pdfs/html-css-basics.pdf' },
        { type: 'link', title: 'HTML Docs', url: 'https://developer.mozilla.org/en-US/docs/Web/HTML' },
        { type: 'link', title: 'CSS Docs', url: 'https://developer.mozilla.org/en-US/docs/Web/CSS' },
      ],
    },
    {
      id: 2,
      title: 'HTML_CSS_Intermediate',
      description: 'A complete course on HTML and CSS to create responsive and styled webpages.',
      progress: 50,
      isSaved: false,
      imageUrl: '/htI.webp',
  
      resources: [
        { type: 'pdf', title: 'HTML and CSS Intermediate', url: '/pdfs/html-css-intermediate.pdf' },
        { type: 'link', title: 'CSS Flexbox Guide', url: 'https://css-tricks.com/snippets/css/a-guide-to-flexbox/' },
        { type: 'link', title: 'HTML Forms', url: 'https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form' },
      ],
    },
    {
      id: 3,
      title: 'HTML_CSS_Advanced',
      description: 'Advanced techniques in HTML and CSS for creating complex layouts and animations.',
      progress: 0,
      isSaved: true,
      imageUrl: '/htA.jpg',
  
      resources: [
        { type: 'pdf', title: 'Advanced HTML and CSS Techniques', url: '/pdfs/html-css-advanced.pdf' },
        { type: 'link', title: 'CSS Grid Layout', url: 'https://css-tricks.com/snippets/css/complete-guide-grid/' },
        { type: 'link', title: 'HTML5 Best Practices', url: 'https://www.html5rocks.com/en/' },
      ],
    },
  ]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mb-4">
          <div className="flex items-center space-x-1 mb-4">
            ...
            <h1 className="text-4xl font-bold mb-2">HTML/CSS</h1>
          </div>
  ...
  />
            ...
            <div className="p-6">
              ...
              <div className="mt-4">
                <button 
                  onClick={() => {
                    if (course.id === 1) navigate({ to: '/courses/htmlcssdebutante' });
                    else if (course.id === 2) navigate({ to: '/courses/htmlcssintermediaires' });
                    else if (course.id === 3) navigate({ to: '/courses/htmlcssadvanced' });
                  }}
