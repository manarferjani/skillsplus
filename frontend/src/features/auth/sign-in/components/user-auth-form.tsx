...
export function UserAuthForm({ className, ...props }: UserAuthFormProps) {
 ...
 async function onSubmit(data: z.infer<typeof formSchema>) {
  try {
    ...
    if (response.success) {
      console.log('Réponse signIn:', response)
      ...
      console.log('User dans store:', response.user)
      ...
      toast({ variant: 'destructive', description: response.message || 'Erreur de connexion' })
    }
  } catch (err: any) {
